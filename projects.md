...
- Integration of PZT sensors into cement slurry
- Monitoring signal responses to detect bonding quality
- Comparative analysis with conventional cement bond logs

**Outcomes & Innovations:**

- Proposed a real-time monitoring alternative
- Improved accuracy in detecting micro-annuli and cement failure
...
- Model creation in CMG
- History matching and sensitivity analysis
- Simulation of waterflooding scenarios

**Outcomes:**

- Understanding of production optimization
- Identification of key parameters affecting recovery
